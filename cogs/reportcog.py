...
class ReportModal(discord.ui.Modal, title="Sup, what you've been up to?"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await SubmitButtonView.modalcallback(
                self, interaction, description_output, artefact_output
            )
...
class SubmitButtonView(discord.ui.View):
    ...
    @discord.ui.button(
        label="add description", style=discord.ButtonStyle.gray, emoji="➕", row=0
    )
    ...
    @discord.ui.button(
        label="Submit Report", style=discord.ButtonStyle.gray, emoji="📜", row=0
    )
    ...
    async def modalcallback(
        self, interaction: discord.Interaction, description_output, artefact_output
    ):
...
class TestMenuCog(commands.Cog):
    ...
    async def tc(self, ctx):
        ...
        view3 = ReportModal(timeout=None)
        ...
        await ctx.send(
            f"You are about to pick the following:\
        ...
        await view2.wait()
        print(
            f"{view2.artefact}, {view2.artefactreply}, {SubmitButtonView.artefact}, {SubmitButtonView.artefactreply}, {ReportModal.artefact}, {ReportModal.artefact.value}"
        )
